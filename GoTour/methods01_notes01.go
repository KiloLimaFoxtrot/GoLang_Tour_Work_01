...
func main() {
	...
	/*
		...
		In this example,
		the Abs method has a receiver of type Vertex02 named v.
	...
	*/
	...
	// Here just below,
	// we have a variable v1AbsVal assigned to the method call Abs()
	
	// The method call Abs() broken down is,
	// 1. A call on the function Abs(), which is
	// 2. defined on the data type v1,
	// which is a struct defined as VrtxStrct01 (
	// instantiated and initialized above)
	
	// The method Abs() is instantiated/initialized/defined further
	// below
...
// Abs() method instantiation/initialization/definition etc...
...
// ie this method defines Abs() (with a return tpye of float64)
